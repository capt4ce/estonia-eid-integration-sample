...
import { SendTxBuilder, EstoniaEid } from '../../../';

const SendTxBuilder = ({ sender, recipient, fee, amount }) => {
  // mock txBuilder returning Tx bytes
...
export default SignSendTxWithEid;
